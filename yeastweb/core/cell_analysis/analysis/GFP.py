...
class NucleusIntensity(Analysis):
    def calculate_statistics(self,best_contour,mcherry_line_pts):
        """
...
def calculate_nucleus_intensity(cp,best_contour,mcherry_line_pts,output_dir, preprocessed_images:GrayImage):
    """
    This function calculate the nucleus intensity within a green image
    :param gray: Gray scale of green image
    """
    gray_GFP = preprocessed_images.get_image('GFP')
    gray_GFP_no_bg = preprocessed_images.get_image('GFP_no_bg')
